      ...
      <div class="container">
         <div class="row" style="margin-top:80px">
            <div class="col-md-4 col-md-offset-6">
               <h4>Register Coordinator</h4><hr>
               <form action="<?php echo e(route('auth.save1')); ?>" method="post">
...
</html><?php /**PATH C:\Users\MFaiz\Documents\GitHub\project\resources\views/auth/register1.blade.php ENDPATH**/ ?>