          ...
          <div class="collapse navbar-collapse" id="collapsibleNavbar">
            <ul class="navbar-nav">
              ...
              <li class="nav-item"><a class="nav-link" href="<?php echo e(route('auth.logout')); ?>">Logout</a></li>
               <li class="nav-item" style="float:right"><a class="nav-link disabled" href="#"><?php echo e($LoggedUserInfo['name']); ?></li> 
            </ul>
          </div>
        </div>
      </nav>
...
</html><?php /**PATH C:\Users\FAIZ\Documents\GitHub\project\resources\views/panel/dashboard.blade.php ENDPATH**/ ?>