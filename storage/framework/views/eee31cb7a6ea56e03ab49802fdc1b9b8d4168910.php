      ...
      <div class="container">
         <div class="row" style="margin-top:80px">
            <div class="col-md-4 col-md-offset-4">
               <h4>Register Supervisor</h4><hr>
               <form action="<?php echo e(route('auth.save2')); ?>" method="post">
...
</html><?php /**PATH C:\Users\MFaiz\Documents\GitHub\project\resources\views/auth/register2.blade.php ENDPATH**/ ?>