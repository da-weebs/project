...
} elseif ($_instance->childHasBeenRendered('5FTYIB4')) {
    $componentId = $_instance->getRenderedChildComponentId('5FTYIB4');
    $componentTag = $_instance->getRenderedChildComponentTagName('5FTYIB4');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('5FTYIB4');
} else {
    $response = \Livewire\Livewire::mount('students');
    $html = $response->html();
    $_instance->logRenderedChild('5FTYIB4', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            </div>
...
</html><?php /**PATH C:\Users\FAIZ\Documents\GitHub\project\resources\views/search.blade.php ENDPATH**/ ?>